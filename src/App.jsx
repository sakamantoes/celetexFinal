...
// You need to export these from your assets/image.js file
// Example: export const logo01Png = '/path/to/logo.png';
        ...
        <div className="nav-container">
          <div className="nav-logo">
            <span className="nav-logo-mark-hover">
              <img src={images.main} alt="Celetex Group Logo" className="nav-logo-img" />
            </span>
          </div>
        ...
        <div className="mobile-menu-header">
          <div className="nav-logo">
            <span className="nav-logo-mark">
              <img src={images.main} alt="Celetex Group Logo" className="w-full h-full object-cover rounded-lg" />
            </span>
      ...
      <footer className="footer">
        <div className="footer-top">
          ...
          <div className="footer-col">
            ...
            <a href="#cybermall-app">Cybermall</a>
          </div>
          <div className="footer-col">
            <h4>Contact</h4>
